...
export default function EduDetailPanel({ ward, wards, onClose }: Props) {
  ...
  const col = dc(ward.imd_edu_decile);
      ...
      <div className="d-hdr">
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
          <div>
            ...
            <div className="d-sub">{ward.ward_code} · rank {ward.edu_rank}/{wards.length} · IMD edu decile {ward.imd_edu_decile}/10</div>
          </div>
        ...
        <div className="q-banner" style={{ borderColor: col, background: col + '0d' }}>
          <div className="q-banner-txt">
            IMD 2025 education-domain decile <strong>{ward.imd_edu_decile}/10</strong> —{' '}
            {ward.imd_edu_decile >= 8 ? 'among the most skills-deprived wards in the city'
              : ward.imd_edu_decile >= 5 ? 'above the city average for skills deprivation'
              : ward.imd_edu_decile >= 3 ? 'below the city average for skills deprivation'
        ...
        <div className="d-chips">
          ...
          <div className="d-chip">
            <div className="d-chip-lbl">IMD edu decile</div>
            <div className="d-chip-val" style={{ color: col }}>{ward.imd_edu_decile}/10</div>
            <div className="d-chip-sub">2025 education domain</div>
          </div>
          <div className="d-chip">
